...
$aModule = [
    ...
    'settings'    => [
        ['group' => 'agcookiecompliance_layout', 'name' => 'sBannerPosition', 'type' => 'select', 'value' => 'bottom', 'constraints' => 'bottom|top|bottom-left|bottom-right'],
        ['group' => 'agcookiecompliance_layout', 'name' => 'blStaticBanner', 'type' => 'bool', 'value' => false],
        ['group' => 'agcookiecompliance_layout', 'name' => 'sBannerTheme', 'type' => 'select', 'value' => 'block', 'constraints' => 'block|edgeless|classic|custom'],
        ['group' => 'agcookiecompliance_colors', 'name' => 'sBannerBackgroundColor', 'type' => 'str', 'value' => '#eaf7f7'],
        ['group' => 'agcookiecompliance_colors', 'name' => 'sBannerTextColor', 'type' => 'str', 'value' => '#5c7291'],
        ['group' => 'agcookiecompliance_colors', 'name' => 'sButtonBackgroundColor', 'type' => 'str', 'value' => '#56cbdb'],
        ['group' => 'agcookiecompliance_colors', 'name' => 'sButtonTextColor', 'type' => 'str', 'value' => '#ffffff'],
        ['group' => 'agcookiecompliance_colors', 'name' => 'sHighlightBackgroundColor', 'type' => 'str', 'value' => '#d65959'],
        ['group' => 'agcookiecompliance_colors', 'name' => 'sHighlightTextColor', 'type' => 'str', 'value' => '#ffffff'],
        ['group' => 'agcookiecompliance_colors', 'name' => 'sHighlightBorderColor', 'type' => 'str', 'value' => '#d65959'],
        ['group' => 'agcookiecompliance_settings', 'name' => 'sConsentType', 'type' => 'select', 'value' => 'categories', 'constraints' => 'categories|opt-in|opt-out|info'],
        ['group' => 'agcookiecompliance_settings', 'name' => 'sInfoLink', 'type' => 'str', 'value' => ''],
        ['group' => 'agcookiecompliance_settings', 'name' => 'blTrainingMode', 'type' => 'bool', 'value' => false],
    ],
    'blocks'      => [
